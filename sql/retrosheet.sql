...
,OUTS_CT varchar(1)
,BALLS_CT varchar(1)
,STRIKES_CT varchar(1)
,PITCH_SEQ_TX varchar(40)
,AWAY_SCORE_CT varchar(5)
,HOME_SCORE_CT varchar(5)
,BAT_ID varchar(8)
...
,BASE4_UMP_ID varchar(16)
,BASE1_UMP_ID varchar(16)
,BASE2_UMP_ID varchar(16)
,BASE3_UMP_ID varchar(16)
,LF_UMP_ID varchar(8)
,RF_UMP_ID varchar(8)
...
,INPUT_RECORD_TS varchar(24)
,EDIT_RECORD_TS varchar(24)
...
CREATE TABLE retrosheet.LKUP_CD_BASES		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_BATTEDBALL		(VALUE_CD varchar(1),	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_EVENT		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_FLD		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_H			(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_HAND		(VALUE_CD varchar(1),	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_PARK_DAYNIGHT	(VALUE_CD varchar(1),	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_PARK_FIELD		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_PARK_PRECIP	(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_PARK_SKY		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_PARK_WIND_DIRECTION(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_RECORDER_METHOD	(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_CD_RECORDER_PITCHES	(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_ID_BASE		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_ID_HOME		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
CREATE TABLE retrosheet.LKUP_ID_LAST		(VALUE_CD INTEGER,	SHORTNAME_TX varchar(8), LONGNAME_TX varchar(30), DESCRIPTION_TX varchar(255) );
